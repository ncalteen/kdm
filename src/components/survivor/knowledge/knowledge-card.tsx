  ...
  return (
    <Card className="mt-2 min-w-[500px]">
      <CardHeader className="pb-2">
        <CardTitle className="text-lg">Knowledges</CardTitle>
      </CardHeader>
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-start gap-2 mt-2">
            <div className="flex-grow">
              <div className="flex flex-col gap-1">
                ...
                />
                <FormLabel className="text-xs">Knowledge Name</FormLabel>
              </div>
            </div>
            <div>
          ...
          <div className="mt-2">
            <div className="flex flex-col gap-1">
              ...
              />
              <FormLabel className="text-xs">Observation Conditions</FormLabel>
            </div>
          </div>
